...
const translations = {
  es: {
    ...
    intro3_html:
      'Esta plataforma tiene por objetivo compilar y visualizar los datasets publicados por el instituto en repositorios como<a href="https://www.gbif.org/publisher/29ef4f00-20db-41f8-b1ad-b5fd3c557c38" target="_blank"><strong>GBIF</strong></a> y <a href="https://zenodo.org/communities/institutobase/" target="_blank"><strong>Zenodo</strong></a>, asegurando el acceso a los datos generados por nuestros investigadores, además de promover la colaboración y la reproducibilidad científica.',
    intro4_html:
  ...
  en: {
    ...
    intro3_html:
      'intro3_html:
      'This platform aims to compile and visualize the datasets published by the institute in repositories such as <a href="https://www.gbif.org/publisher/29ef4f00-20db-41f8-b1ad-b5fd3c557c38" target="_blank"><strong>GBIF</strong></a> and <a href="https://zenodo.org/communities/institutobase/" target="_blank"><strong>Zenodo</strong></a>, ensuring access to the data generated by our researchers, while promoting scientific collaboration and reproducibility.',
    intro4_html:
